...
android {
    ...
    buildFeatures {
        compose = true
        viewBinding = false // Removing XML
    }
...
dependencies {
    ...
    implementation("androidx.compose.ui:ui-unit")  // Explicitly add unit for dp/sp
    ...
    implementation("io.coil-kt:coil-compose:2.5.0") // Using Coil for Compose images
